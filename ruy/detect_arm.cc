...
bool IsLinuxAuxvMethodAvailable() {
  ...
  // This is implemented in linux 4.14.151 and in 4.15.
  // This is not in linux 4.14.150.
  // Checked using the source browser at:
  // https://elixir.bootlin.com/linux/v4.14.151/source/arch/arm64/include/uapi/asm/hwcap.h
  using tuple = std::tuple<int, int, int>;
  return tuple(major, minor, patch) >= tuple(4, 14, 151);
}
